...
| --- | --- | --- |
| [WP00](work-packages/WP00.md) | Pinned bootstrap and evidence tooling | None |
| [WP01](work-packages/WP01.md) | Public definitions and coupled interface freeze | WP00 |
...
| [WP22](work-packages/WP22.md) | All-dimensional comparison | WP13, WP19, WP20, WP21 |
...
Do not keep all work waiting for a complete universal derivative. Start the actual triangle subcases and independent branches after their definitions freeze. Conversely, a completed scalar file is not evidence that the singular analytic seam is paid. The concrete derivative probe should culminate before accepting the universal interface; it is also a permanent regression test.

The machine-readable graph is WORK_PACKAGES.json. The lead owns coordinated edits to definitions and the release root; no two workers own the same file concurrently. Each card records its assignment and evidence. There is no arbitrary task-count, time or token stopping rule.
